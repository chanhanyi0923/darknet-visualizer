    ...
    node: function (x, y, w, h, connectors, text, fillStyle, figure, args) {
        ...
        this.draw = function (ctx) {
            if (this.figure === undefined) {
                this.figure(ctx, this);
            } else {
                model.defaultNodeRenderer(ctx, this);
            }
        ...
        this.connectorCoords = function (connectorIndex) {
            return {
                x: this.x + this.connectors[connectorIndex].x * this.w,
        ...
        if (mouse.dragging != null) {
            if (mouse.dragging == "newlink") {
                if (mouse.linkDestNode != null) {
                    // Dispatch/Trigger/Fire the event
                    var event = new CustomEvent("nodesLinked", {'detail': {'from': mouse.selConnectorNode, 'to': mouse.linkDestNode}});
                    document.dispatchEvent(event);
